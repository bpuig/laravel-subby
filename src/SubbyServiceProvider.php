...
class SubbyServiceProvider extends ServiceProvider
{
    ...
    protected function publishMigrations()
    {
        $this->publishes([
            ...
            __DIR__ . '/../database/migrations/create_plan_subscription_schedules_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time() + 5) . '_create_plan_subscription_usage_table.php')
        ], 'subby.migrations');
        ...
        $this->publishes([
            ...
            __DIR__ . '/../database/migrations/v5.0.0/create_plan_subscription_schedules_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time() + 2) . '_alter_plan_subscriptions_table_v5.php'),
