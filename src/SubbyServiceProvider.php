...
class SubbyServiceProvider extends ServiceProvider
{
    ...
    protected function publishMigrations()
    {
        ...
        $this->publishes([
            __DIR__ . '/../database/migrations/v4.0.0/create_plan_subscription_features_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time()) . '_create_plan_subscription_features_table.php'),
            __DIR__ . '/../database/migrations/v4.0.0/alter_plans_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time() + 1) . '_alter_plan_table.php'),
            __DIR__ . '/../database/migrations/v4.0.0/alter_plan_subscription_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time() + 2) . '_alter_plan_subscription_table.php'),
            __DIR__ . '/../database/migrations/v4.0.0/alter_plan_subscription_usage_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time() + 3) . '_alter_plan_subscription_usage_table.php'),
